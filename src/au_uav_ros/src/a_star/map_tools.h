...
#define DEFAULT_PADDING 0.00125 // original .00075
#define DEFAULT_RESOLUTION 11.0 // original 10
...
namespace map_tools
{
     ...
     */
    int find_width_in_squares( double width_of_field,
     ...
     *         empty and the function will assign it the proper value.
     */
    int find_height_in_squares( double width_of_field,
                                        double height_of_field,
                                        double map_resolution );
...
int map_tools::find_width_in_squares( double width_of_field,
                                              double height_of_field,
                                              double map_resolution )
{
...
int map_tools::find_height_in_squares( double width_of_field,
                                               double height_of_field,
                                               double map_resolution )
{
                                ...
                                double & out_latitude_2, double & out_longitude_2 )
{
    ...
    out_longitude_2 *= MY_RADIANS_TO_DEGREES;
    out_latitude_2 *= MY_RADIANS_TO_DEGREES;
}
                                   ...
                                   double latitude_2, double longitude_2 )
{
    ...
    return atan2(y, x)*MY_RADIANS_TO_DEGREES;
}
                                              ...
                                              int x_2, int y_2 )
{
    int d_y = y_2 - y_1;
    int d_x = x_2 - x_1;
    return atan2( d_y, d_x )*MY_RADIANS_TO_DEGREES + 90;
}


double map_tools::to_radians( double angle_in_degrees )
{
    return ( angle_in_degrees * MY_DEGREES_TO_RADIANS );
}
