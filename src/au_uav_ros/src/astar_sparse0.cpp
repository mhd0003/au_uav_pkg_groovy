...
#include "au_uav_ros/stlastar.h" // See header for copyright and usage information
...
#include "au_uav_ros/pathLogger.h"

/**
 * Is the path that A* recommends our plane take
 */
std::queue<point> a_path;
...
public:
     ...
     */
    std::queue<bearing_t> legal_expansions_for_child;
     ...
     */
    MapSearchNode( unsigned int px, unsigned int py, unsigned int t_step, bearing_t parent, std::queue<bearing_t> my_maneuver)
    {
        x=px;
        y=py;
...
bool MapSearchNode::GetSuccessors( AStarSearch<MapSearchNode> *astarsearch, MapSearchNode *parent_node )
{
	...
	// TODO make this get the extendedTime from dangerGrid
    time_z = timestep+1>50 ? 50 : 1+timestep;
